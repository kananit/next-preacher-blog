...
| Параметр | Значение |
|---|---|
| **Название** | Blog Nextjs (Конспекты проповедей) |
| **Базовый шаблон** | next-tailwind-boilerplate от themefisher.com |
| **Деплой** | Яндекс Cloud → `hosea.ru` |
| **Next.js** | 13.5.11 |
| **React** | 18.2.0 |
...
- **Название сайта**: "Конспекты проповедей"
...
- **Деплой**: Яндекс Cloud Object Storage (`scripts/deploy.sh`)
...
Полнофункциональный **русскоязычный блог на Next.js 13** для публикации AI-конспектов проповедей. Используется boilerplate от themefisher.com, кастомизированный под русский контент с уникальной цветовой палитрой. Архитектура чистая, код хорошо структурирован, есть всё необходимое для ведения блога: категории, поиск, пагинация, похожие посты, тёмная тема, SEO — деплой на Яндекс Cloud Object Storage.
