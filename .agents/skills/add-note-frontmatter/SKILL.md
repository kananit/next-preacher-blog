...
- Если оригинальный заголовок из `##` слишком длинный — сокращай его без потери смысла:
  - Убирай перечисления (например, «сердечных, умственных, телесных…» → опустить перечисление).
